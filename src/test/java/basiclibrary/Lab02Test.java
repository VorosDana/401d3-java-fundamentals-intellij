...
public class Lab02Test {
    ...
    @Test
    public void TestRollOutputRangeFifteen() {
        assertTrue( rollTestHelper( Lab02.roll(15) ) );
    }
    ...
    @Test
    public void TestContainsDuplicatesBadInput(){
        assertFalse(Lab02.containsDuplicates(new int[0]));
    }
    ...
    @Test
    public void TestArrayOfArraysIncludesEmptyArrayAndNegative(){
        assertArrayEquals(new int[] {10, 20, -300}, Lab02.arrayOfArrays(new int[][] {{2, 3, 4}, {10, 20, -300}, {8, 9}, new int[0]}));
    }
